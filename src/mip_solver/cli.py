...
from mip_solver.enumerator import enumerate_modes
from mip_solver.solve import solve_schedule
...
def _run_solve(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        print(f"mip_solver solve failed: {exc}", file=sys.stderr)
        return 2
...
def _run_enumerate(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        print(f"mip_solver enumerate failed: {exc}", file=sys.stderr)
        return 2
