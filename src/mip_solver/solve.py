...
from mip_solver.metrics import extract_metrics
from mip_solver.modes import TrafficMode, _MODE_SPECS
from mip_solver.constraints import (
...
from mip_solver.objectives import (
    add_utilization_capacity_constraints,
    build_objective,
    build_utilization_terms,
)
from mip_solver.schedule import SNN_GB_START_LEVEL, create_schedule_vars
from mip_solver.objectives.traffic import (
...
def solve_schedule(
    ...
    model = Model("mip_solver_schedule")
